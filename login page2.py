...
def reg():
    ...
    Label(reg_screen, text="Please enter details below to register", bg="yellow").pack()
    Label(reg_screen, text="").pack()
    username_lable = Label(reg_screen, text="Username * ")
    username_lable.pack()
    ...
    password_entry.pack()
    Label(reg_screen, text="").pack()
    Button(reg_screen, text="Register", width=12, height=2, bg="yellow", command = register_user).pack()
...
def login():
    ...
    Label(login_screen, text="Please enter details below to login your account").pack()
...
def register_user():
    ...
    Label(reg_screen, text="Registration Success", fg="blue", font=("calibri", 11)).pack()
